...
import { Hotel, Loader2, UserPlus, ArrowRight, User, Mail, Lock, Shield } from 'lucide-react';
...
const Register = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            alert(res.message || 'Registration successful! Your account is now pending admin approval.');
            navigate('/login');
        } catch (err) {
    ...
    return (
        <div className="min-h-screen bg-white dark:bg-navy-950 flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden transition-colors duration-500">
            ...
            <div className="absolute top-0 left-0 w-full h-full overflow-hidden -z-10 pointer-events-none">
                ...
                <div className="absolute top-1/2 -right-24 w-80 h-80 bg-primary-500/10 rounded-full blur-3xl"></div>
            </div>
            ...
            <div className="sm:mx-auto sm:w-full sm:max-w-md relative">
                ...
                <h2 className="mt-8 text-center text-4xl font-bold text-gray-900 dark:text-white tracking-tight">
                    Join <span className="text-cyan-600 dark:text-cyan-400">LuxeStay</span>
                </h2>
            ...
            <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-[500px] px-4">
                <div className="bg-white/50 dark:bg-navy-900/50 backdrop-blur-xl border border-gray-200 dark:border-white/5 py-10 px-6 sm:px-10 rounded-[32px] shadow-2xl relative">
                    ...
                    <form className="space-y-5" onSubmit={handleSubmit}>
                        <div className="space-y-2">
                            <label className="text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-widest ml-1 flex items-center">
                                <User className="w-3 h-3 mr-2 text-cyan-500" /> Full Name
                            </label>
                            <input
                                name="name"
                                type="text"
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div className="space-y-2">
                                <label className="text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-widest ml-1 flex items-center">
                                    <Shield className="w-3 h-3 mr-2 text-cyan-500" /> Confirm
                                </label>
                                <input
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full bg-cyan-500 hover:bg-cyan-400 text-white py-4 rounded-2xl font-bold shadow-soft transition-all active:scale-[0.98] disabled:opacity-70 disabled:pointer-events-none flex items-center justify-center space-x-2 group relative overflow-hidden mt-4"
                        >
                    ...
                    <div className="mt-8 text-center pt-8 border-t border-gray-100 dark:border-white/5">
                        <p className="text-sm text-gray-500 font-medium">
                            ...
                            <Link to="/login" className="text-cyan-600 dark:text-cyan-400 font-bold hover:text-cyan-500 dark:hover:text-cyan-300 transition-colors">
                                Sign in here
                            </Link>
                        </p>
                    </div>
